...
namespace WinHtmlEditor
{
    ...
    public sealed partial class HtmlEditor : UserControl
    {
        ...
        private const string HTML_TITLE_EDIT = "编辑HTML代码";
        ...
        public string BodyInnerHTML
        {
            ...
            set
            {
                ...
                {
                    throw new HtmlEditorException("无法设置主体的内部Html。", "设置内部Html", ex);
                }
            }
        }
        ...
        public string BodyHtml
        {
            ...
            set
            {
                ...
                {
                    throw new HtmlEditorException("无法设置主体的外部Html。", "设置Html主体", ex);
                }
            }
        ...
        private void ExecuteCommandRange(mshtmlTextRange range, string command, object data)
        {
            ...
            {
                // Unknown error so inform user
                throw new HtmlEditorException("未知MSHTML错误。", command, ex);
            }
            ...
            try
            {
                ...
                switch (command)
                {
                    ...
                    case INTERNAL_COMMAND_ABOUT:
                        MessageBox.Show(Resources.AboutInfo, Resources.AboutText, MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                        break;
                    default:
                        throw new HtmlEditorException("正在执行的未知操作。", command);
                }
                WordCount();
            }
